...
export const LINKS_DATA: LinkGroup[] = [
  ...
  },
  {
    category: 'extras',
    links: [
      { label: 'relx', url: 'https://www.vapepenzone.jp/products/relx-infinity-pod-3-pods-pack/', icon: 'https://www.google.com/s2/favicons?domain=vapepenzone.jp&sz=64' },
      { label: 'amazon', url: 'https://www.amazon.co.jp/', icon: 'https://www.google.com/s2/favicons?domain=amazon.co.jp&sz=64' },
      { label: 'moji', url: 'https://www.mojidict.com/', icon: 'https://www.google.com/s2/favicons?domain=mojidict.com&sz=64' },
      { label: 'z-lib', url: 'https://zh.zlib.li/', icon: 'https://www.google.com/s2/favicons?domain=zlib.li&sz=64' },
    ]
  },
  {
    category: 'media',
